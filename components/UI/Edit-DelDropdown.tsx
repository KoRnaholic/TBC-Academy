...
export default function EditDeltDropdown({ courseId }: { courseId: number }) {
  ...
  return (
    <>
      <div ref={dropdownRef} className="relative">
        ...
        >
          <svg
            className="inline-block h-6 w-6 fill-current dark:invert"
            viewBox="0 0 24 24"
          >
      ...
      {modalIsOpen && (
        <CourseEditModal setModalIsOpen={setModalIsOpen} courseId={courseId} />
      )}
