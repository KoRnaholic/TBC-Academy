...
export default function ContactInfo() {
  return (
    <>
      <div className="flex gap-5 justify-center flex-wrap font-sans mt-20 text-gray-600">
        <div className="flex flex-col w-1/2 xl:w-1/5 py-5 border justify-center items-center gap-2 rounded-xl">
